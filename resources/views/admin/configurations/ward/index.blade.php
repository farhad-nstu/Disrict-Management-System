        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card-header">
              ...
              <a href="{{ route('ward.create') }}" class="btn btn-sm btn-primary float-right">Add New</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{ $loop->index+1 }}</td>
                  <td>{{ $ward->name }}</td>
                  <td>{{ $ward->pouroshava }}</td>
                  <td>{{ $ward->zilla }}</td>
                  <td class="text-center">

                    <a type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#view_modal{{ $ward->id }}"><i class="fas fa-eye"></i></a>

                    <a href="{{ route('ward.edit', $ward->id) }}" type="button" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="row">
                          <label class="col-sm-4">Pouroshava</label>   
                          <p class="col-sm-8">{{ $ward->pouroshava }}</p>          
                        </div>
                        <div class="row">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer justify-content-between">
                        ...
                        <div class="col-sm-1">
                          <a href="{{ route('ward.delete', $ward->id) }}" type="button" class="btn btn-danger btn-sm">Delete</a>
                        </div>
